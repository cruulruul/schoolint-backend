...
CREATE TABLE IF NOT EXISTS `schoolint`.`InterviewResult` (
  ...
  `created` DATETIME NOT NULL DEFAULT NOW(),
  `comment` TEXT NULL,
  `interview_cat1` TINYINT NOT NULL DEFAULT 0,
  `interview_cat2` TINYINT NOT NULL DEFAULT 0,
  `interview_cat3` TINYINT NOT NULL DEFAULT 0,
  `interview_cat4` TINYINT NOT NULL DEFAULT 0,
  `interview_cat5` TINYINT NOT NULL DEFAULT 0,
  `interview_cat6` TINYINT NOT NULL DEFAULT 0,
  `interview_cat7` TINYINT NOT NULL DEFAULT 0,
  `interview_cat8` TINYINT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
