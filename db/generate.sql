...
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'address;Aadress: tegelik');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'phone;Telefon');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'notes|null;Märkused');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'exam1|null;Eesti keel (Riigieksam)');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'exam2|null;Eesti keel teise keelena (Riigieksam)');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'exam3|null;Emakeel (eesti keel) (Riigieksam)');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'exam4|null;Inglise keel (võõrkeel) (Riigieksam)');
...
START TRANSACTION;
USE `schoolint`;
INSERT INTO `schoolint`.`Course` (`id`, `name`) VALUES (1, 'RIF');
INSERT INTO `schoolint`.`Course` (`id`, `name`) VALUES (2, 'LO');
INSERT INTO `schoolint`.`Course` (`id`, `name`) VALUES (3, 'KTD');
...
START TRANSACTION;
USE `schoolint`;
INSERT INTO `schoolint`.`Tag` (`id`, `name`, `Course_id`) VALUES (DEFAULT, 'Innukas', 1);
INSERT INTO `schoolint`.`Tag` (`id`, `name`, `Course_id`) VALUES (DEFAULT, 'Tubli', 2);
