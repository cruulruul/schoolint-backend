...
CREATE TABLE IF NOT EXISTS `schoolint`.`InterviewResult` (
  ...
  `created` DATETIME NOT NULL DEFAULT NOW(),
  `comment` TEXT NULL,
  `interview_cat1` FLOAT NULL DEFAULT 0,
  `interview_cat2` FLOAT NULL DEFAULT 0,
  `interview_cat3` FLOAT NULL DEFAULT 0,
  `interview_cat4` FLOAT NULL DEFAULT 0,
  `interview_cat5` FLOAT NULL DEFAULT 0,
  `interview_cat6` FLOAT NULL DEFAULT 0,
  `interview_cat7` FLOAT NULL DEFAULT 0,
  `interview_cat8` FLOAT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
INSERT INTO `schoolint`.`User` (`id`, `first_name`, `last_name`, `email`, `password`, `UserRole_id`, `Course_id`, `deleted`, `created`) VALUES (DEFAULT, 'Test', 'LO', 'testlo@yourdomain.com', '$2b$10$lFDL6gaNdGUa4JkpxD/8t.2ekVyuLr6oWduLuQAZBH9IW3WsYTHiG', 2, 2, DEFAULT, DEFAULT);
INSERT INTO `schoolint`.`User` (`id`, `first_name`, `last_name`, `email`, `password`, `UserRole_id`, `Course_id`, `deleted`, `created`) VALUES (DEFAULT, 'Test', 'KTD', 'testktd@yourdomain.com', '$2b$10$GRpI3.c.2SuG3oITT7XU9.0vPsl.b1P8d0w3au/GZmkObKGYa447C', 2, 3, DEFAULT, DEFAULT);
