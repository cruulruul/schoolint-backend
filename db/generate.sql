...
START TRANSACTION;
USE `schoolint`;
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'Isikukood');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'Eesnimi');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'Perenimi');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'E-post');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'Aadress');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'Telefon');
INSERT INTO `schoolint`.`TemplateFields` (`id`, `TemplateSheet_id`, `name`) VALUES (DEFAULT, 1, 'Märkused');
